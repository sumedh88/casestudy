...
execute "Get war file" do
    command "/usr/bin/svn co --depth=immediates --username niloday_tamhankar --password Dev0ps2016  --no-auth-cache --non-interactive --trust-server-cert  https://svn.persistent.co.in/svn/DevOps_Compt/niloday_tamhankar /root/"
end
